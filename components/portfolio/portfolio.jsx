    ...
    <div className="portfolio-shell" style={{ "--accent": s.primary_color || "#70f0c0" }} data-mode={s.color_mode || "dark"}>
      ...
      <main id="main">
        ...
        <div className="portfolio-content container">
          {sections.about && <Section id="about" title="About" number={number()} intro="The thinking, craft, and experience behind the work."><div className="about-layout"><div className="about-identity"><p>Professional profile</p><h2>{p.title || p.name}</h2>{p.location && <span>Based in {p.location}</span>}</div><div className="about-story"><p className="pre-line">{p.long_bio}</p></div></div></Section>}
