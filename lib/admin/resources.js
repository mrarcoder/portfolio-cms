export const resources = {
  ...
  projects:{label:"Projects",singular:"project",fields:[['title','Title','text',true],['slug','Slug','text',true],['summary','Summary','textarea'],['description','Description','textarea'],['gallery_media','Project gallery','gallery'],['technologies','Technologies (comma separated)'],['github_url','GitHub URL','url'],['live_url','Live URL','url'],['start_date','Start date','date',true],['end_date','End date','date'],['progress','Progress','select',true,['completed','in_progress','archived']],['visible','Visible','checkbox']]},
