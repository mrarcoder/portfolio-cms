...
Read `docs/AGENTS.yml`, `docs/SCOPE.yml`, and `docs/PROGRESS.yml` before changing the project. Use JavaScript, keep changes inside the accepted scope, and preserve the separation between Next.js presentation and the Worker backend.
