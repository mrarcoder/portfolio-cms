...
const resourceSpecs = {
  ...
  projects: { table: "projects", fields: ["title","slug","summary","description","image_media_id","video_media_id","technologies_json","github_url","live_url","start_date","end_date","progress","visible"], required: ["title","slug","start_date"], dates: ["start_date","end_date"], booleans: ["visible"], integers: ["image_media_id","video_media_id"] },
