...
const allowedTypes = new Map([["image/jpeg",[0xff,0xd8,0xff]],["image/png",[0x89,0x50,0x4e,0x47]],["image/webp",null],["application/pdf",[0x25,0x50,0x44,0x46]],["video/mp4",null],["video/webm",[0x1a,0x45,0xdf,0xa3]]]);
...
export async function uploadMedia(request,env){
  ...
  const extension={"image/jpeg":"jpg","image/png":"png","image/webp":"webp","application/pdf":"pdf","video/mp4":"mp4","video/webm":"webm"}[file.type];const key=`media/${crypto.randomUUID()}.${extension}`;
